...
print("\n5. Расходы на Авито из кошелька (Ирик, 21.09)")
операции = [
    {"amountTotal": 20875, "operationType": "аванс", "operationName": "Пополнение Авито Кошелька", "updatedAt": t(14)},
    {"amountTotal": 7056, "operationType": "резервирование средств под услугу", "serviceName": "Авторассылка скидок в SBC", "updatedAt": t(14)},
    {"amountTotal": 1953, "operationType": "резервирование средств под услугу", "serviceName": "Продвижение", "updatedAt": t(14)},
    {"amountTotal": 2226, "operationType": "возврат зарзервированных средств на баланс кошелька", "serviceName": "Авторассылка скидок в SBC", "updatedAt": t(16)},
]
ав = д.расходы_авито(операции)
проверить("пополнение не расход, услуги суммируются по дню", ав["2026-09-14"]["руб"], 9009.0)
проверить("возврат вычитается в день возврата", ав["2026-09-16"]["руб"], -2226.0)
проверить("разбивка по услугам", ав["2026-09-14"]["по_услугам"], {"Авторассылка скидок в SBC": 7056.0, "Продвижение": 1953.0})
ряд_а = д.динамика(сделки, история, журнал, сейчас, 8, операции)
и_а = д.итоги(ряд_а)
проверить("итог периода — нетто с возвратом", и_а["авито_руб"], 6783.0)
проверить("по услугам за период — нетто", и_а["авито_по_услугам"], {"Авторассылка скидок в SBC": 4830.0, "Продвижение": 1953.0})
проверить("на лид считается", и_а["авито_на_лид"], round(6783.0 / и_а["новых"], 2))
